...
const Home: NextPage = () => {
  ...
  const setENSOrAddress = async (
    ...
    // `lookupAddress()` performs a reverse lookup of the address in ENS using the Reverse Registrar. If the name does not exist,
    // or the forward lookup does not match, null is returned.
  ...
  */
  ...
  return (
    <div>
      ...
      <footer className="footer">Made with &#10084; by LearnWeb3 Punks</footer>
    </div>
  );
};
